...
@__app_environment_variables_v_1.3 = internal constant [37 x i8] c"7cf5dbc4-c1cc-4e4f-8181-02b142ae411c\00", align 16
...
@__ApplicationConfig_android_package_name.0 = internal constant [31 x i8] c"com.companyname.mobiletrashbin\00", align 16
...
@__DSOCacheEntry_name.39 = internal constant [29 x i8] c"libaot-MobileTrashBin.dll.so\00", align 16
...
@dso_cache = local_unnamed_addr global [458 x %struct.DSOCacheEntry] [
	...
	; 40
	%struct.DSOCacheEntry {
		i64 2007793997378826737, ; hash 0x1bdd1e00bbed31f1, from name: libaot-MobileTrashBin.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([29 x i8], [29 x i8]* @__DSOCacheEntry_name.39, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 41
	%struct.DSOCacheEntry {
	...
	; 92
	%struct.DSOCacheEntry {
		i64 3796026878371422159, ; hash 0x34ae32556b29dfcf, from name: MobileTrashBin
		i8 0, ; ignore
		i8* getelementptr inbounds ([29 x i8], [29 x i8]* @__DSOCacheEntry_name.39, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 102
	%struct.DSOCacheEntry {
		i64 4225436319711210882, ; hash 0x3aa3c3f2096bad82, from name: aot-MobileTrashBin
		i8 0, ; ignore
		i8* getelementptr inbounds ([29 x i8], [29 x i8]* @__DSOCacheEntry_name.39, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 179
	%struct.DSOCacheEntry {
		i64 7875829176053811492, ; hash 0x6d4c90e85e584924, from name: MobileTrashBin.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([29 x i8], [29 x i8]* @__DSOCacheEntry_name.39, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 397
	%struct.DSOCacheEntry {
		i64 16086879763022824839, ; hash 0xdf4013e99b654587, from name: aot-MobileTrashBin.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([29 x i8], [29 x i8]* @__DSOCacheEntry_name.39, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 447
	%struct.DSOCacheEntry {
		i64 18167010354278202493, ; hash 0xfc1e2faa0d987c7d, from name: libaot-MobileTrashBin
		i8 0, ; ignore
		i8* getelementptr inbounds ([29 x i8], [29 x i8]* @__DSOCacheEntry_name.39, i32 0, i32 0), ; name
		i8* null; handle
	}, 
