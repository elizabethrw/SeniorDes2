...
@__DSOCacheEntry_name.2 = internal constant [29 x i8] c"libaot-MobileTrashBin.dll.so\00", align 1
...
@dso_cache = local_unnamed_addr global [458 x %struct.DSOCacheEntry] [
	...
	; 1
	%struct.DSOCacheEntry {
		i64 24825327, ; hash 0x17acdef, from name: MobileTrashBin
		i8 0, ; ignore
	...
	; 6
	%struct.DSOCacheEntry {
		i64 105322521, ; hash 0x6471819, from name: libaot-MobileTrashBin.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([29 x i8], [29 x i8]* @__DSOCacheEntry_name.2, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 10
	%struct.DSOCacheEntry {
		i64 146491870, ; hash 0x8bb49de, from name: aot-MobileTrashBin.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([29 x i8], [29 x i8]* @__DSOCacheEntry_name.2, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 44
	%struct.DSOCacheEntry {
		i64 440805341, ; hash 0x1a4627dd, from name: MobileTrashBin.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([29 x i8], [29 x i8]* @__DSOCacheEntry_name.2, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 125
	%struct.DSOCacheEntry {
		i64 1249900399, ; hash 0x4a7ff76f, from name: libaot-MobileTrashBin
		i8 0, ; ignore
		i8* getelementptr inbounds ([29 x i8], [29 x i8]* @__DSOCacheEntry_name.2, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 237
	%struct.DSOCacheEntry {
		i64 2237005517, ; hash 0x8555fecd, from name: aot-MobileTrashBin
		i8 0, ; ignore
		i8* getelementptr inbounds ([29 x i8], [29 x i8]* @__DSOCacheEntry_name.2, i32 0, i32 0), ; name
		i8* null; handle
	}, 
